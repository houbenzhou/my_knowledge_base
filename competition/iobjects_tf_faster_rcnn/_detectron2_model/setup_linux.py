...
def get_extensions():
    ...
    if is_rocm_pytorch:
        ...
        shutil.copy(
            ...
            "layers/csrc/box_iou_rotated/hip/box_iou_rotated_utils.h",
        )
        shutil.copy(
            "layers/csrc/deformable/deform_conv.h",
            "layers/csrc/deformable/hip/deform_conv.h",
        )
