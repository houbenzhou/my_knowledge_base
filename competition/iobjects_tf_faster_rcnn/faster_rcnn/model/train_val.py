...
class SolverWrapper(object):
    ...
    def find_previous(self, pretrained_model_path):
        ...
        for stepsize in cfg.TRAIN.STEPSIZE:
            redfiles.append(os.path.join(pretrained_model_path,
    ...
    def train_model(self, sess, max_iters, last_model_filename, pretrained_model_path):
        ...
        log_path = os.path.abspath(
            os.path.join(os.path.abspath(os.path.join(last_model_filename, os.path.pardir)), os.path.pardir))
            ...
            if iter % cfg.TRAIN.SNAPSHOT_ITERS == 0:
                ...
                if os.path.exists(os.path.join(log_path, 'val_total_loss.txt')):
                    with open(os.path.join(log_path, 'val_total_loss.txt'), 'rb') as f:
                        # f = open(os.path.join(log_path, 'val_total_loss.txt'), 'rb')
...
def train_net(network, imdb, roidb, valroidb, pretrained_model_path, output_dir, out_name, tb_dir,
