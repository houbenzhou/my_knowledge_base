...
def get_parser():
    ...
    parser.add_argument(
        "--img",
        default="/home/data/hou/workspaces/my_knowledge_base/competition/gaofen/domestic/automatic_bridge_detection_in_optical_images_2020/train/images",
        help="voc image path",
    )
    parser.add_argument(
        "--xml",
        default="/home/data/hou/workspaces/my_knowledge_base/competition/gaofen/domestic/automatic_bridge_detection_in_optical_images_2020/train/label_xml",
        help="voc label path",
    )
