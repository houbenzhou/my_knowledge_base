...
def get_parser():
    ...
    parser.add_argument(
        "--input_dota_path",
        default="/home/data/hou/workspaces/my_knowledge_base/competition/gaofen/International/ship_detection_sar/data_v1/test",
        help="Base path for dota data",
    )

    parser.add_argument(
        "--out_path",
        default='/home/data/hou/workspaces/my_knowledge_base/competition/gaofen/International/ship_detection_sar/data_v2/test1',
