...
def get_parser():
    ...
    parser.add_argument(
        "--out_path",
        default='/home/data/hou/workspaces/my_knowledge_base/competition/gaofen/International/ship_detection_sar/data_v2/test2',
...
if __name__ == '__main__':
    ...
    split_data(input_img_path, input_label_path, split_images_path, split_label_path, blocksize=2048, tile_offset=1024)
