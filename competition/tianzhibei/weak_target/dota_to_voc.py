...
def get_parser():
    ...
    parser.add_argument(
        "--input_dota_path",
        default="/home/data/hou/workspaces/my_knowledge_base/competition/gaofen/International/ship_detection_sar/data_v2/train",
        help="Base path for dota data",
    )

    parser.add_argument(
        "--out_voc_path",
        default='/home/data/hou/workspaces/iobjectspy3/resources_ml/out/shipvoc',
