...
def example_train():
    train_data_path = '/home/data1/competition/data/all_aircraft/tzb2_airplane_voc_modify_v2_20210806/spllite_val_voc'
    ...
    log_path = os.path.join(curr_dir, '..', 'out', 'tzb2_airplane_voc_modify_v2_20210806', 'baseline','log')
    output_model_path = os.path.join(curr_dir, '..', 'out', 'tzb2_airplane_voc_modify_v2_20210806', 'baseline', 'model')
