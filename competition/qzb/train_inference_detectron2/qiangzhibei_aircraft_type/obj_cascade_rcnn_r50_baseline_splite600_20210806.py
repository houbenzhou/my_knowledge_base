...
def example_train():
    train_data_path = '/home/data1/competition/data/all_aircraft/tzb2_airplane_voc_modify_v2_20210806/splite_600_voc'
    config = os.path.join(curr_dir, '..','config','qiangzhibei_aircraft_type', 'train_config_cascade_rcnn_R_50_FPN_3x.sdt')
    backbone_weight_path = os.path.join(curr_dir, '..', 'backbone', 'R-50.pkl')

    log_path = os.path.join(curr_dir, '..', 'out', 'tzb2_airplane_voc_modify_v2_20210806', 'baseline_600','log')
    output_model_path = os.path.join(curr_dir, '..', 'out', 'tzb2_airplane_voc_modify_v2_20210806', 'baseline_600', 'model')
    output_model_name = "save_model"
    lr= 0.02
    PictureTrainer(train_data_path=train_data_path, config=config, epoch=100, batch_size=16, lr=lr,
...
def example_predict():
    ...
    model_path = os.path.join(curr_dir, '..', 'out', 'tzb2_airplane_voc_modify_v2_20210806', 'baseline_600', 'model', 'save_model',
                              'save_model.sdm')

    out_data = os.path.join(curr_dir, '..', 'out', 'tzb2_airplane_voc_modify_v2_20210806', 'baseline_600', 'result.udbx')
