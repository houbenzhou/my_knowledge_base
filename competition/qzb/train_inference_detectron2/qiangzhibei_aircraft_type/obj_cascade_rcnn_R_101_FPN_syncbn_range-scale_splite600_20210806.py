...
def example_train():
    train_data_path = '/home/data1/competition/data/all_aircraft/tzb2_airplane_voc_modify_v1_1_20210806/splite_600_voc'

    config = os.path.join(curr_dir, '..','config','qiangzhibei_aircraft_type', 'train_config_cascade_rcnn_R_101_FPN_syncbn_range-scale.sdt')
    backbone_weight_path = os.path.join(curr_dir, '..', 'backbone', 'R-101.pkl')

    log_path = os.path.join(curr_dir, '..', 'out', 'qiangzhibei_aircraft_type','cascade_rcnn_R_101_FPN_syncbn_range-scale', 'splite_voc_600','log')
    output_model_path = os.path.join(curr_dir, '..', 'out', 'qiangzhibei_aircraft_type','cascade_rcnn_R_101_FPN_syncbn_range-scale', 'splite_voc_600', 'model')
    output_model_name = "save_model"

    lr= 0.01
    PictureTrainer(train_data_path=train_data_path, config=config, epoch=5, batch_size=8, lr=lr,
            output_model_path=output_model_path,
            output_model_name=output_model_name, backbone_name='renet50',
            backbone_weight_path=backbone_weight_path, log_path=log_path, reload_model=False,num_gpus=4).object_detect_train()
...
def example_predict():
    image_path = '/home/data1/competition/data/all_aircraft/qinagzhibei_test/airport'
    image_names = os.listdir(image_path)
    model_path = os.path.join(curr_dir, '..', 'out', 'tzb2_airplane_voc_modify_v1_1_20210806', 'baseline_600', 'model', 'save_model',
                              'save_model.sdm')
    out_data = os.path.join(image_path,'result.udbx')

    # out_data = os.path.join(curr_dir, '..', 'out', 'tzb2_airplane_voc_modify_v1_1_20210806', 'baseline_600', 'result.udbx')
...
def example_predict_1000():
    image_path = '/home/data1/competition/data/all_aircraft/qinagzhibei_test/airport'
    image_names = os.listdir(image_path)
    model_path = os.path.join(curr_dir, '..', 'out', 'tzb2_airplane_voc_modify_v1_1_20210806', 'baseline_600', 'model_1000', 'save_model',
                              'save_model.sdm')
    out_data = os.path.join(image_path,'result1000.udbx')
...
def example_predict_1200():
    image_path = '/home/data1/competition/data/all_aircraft/qinagzhibei_test/airport'
    image_names = os.listdir(image_path)
    model_path = os.path.join(curr_dir, '..', 'out', 'tzb2_airplane_voc_modify_v1_1_20210806', 'baseline_600', 'model_1200', 'save_model',
                              'save_model.sdm')
    out_data = os.path.join(image_path,'result1200.udbx')
...
if __name__ == '__main__':
    ...
    example_train()
    # example_predict()
    # example_predict_1000()
    # example_predict_1200()
    # example_predict_pic()
