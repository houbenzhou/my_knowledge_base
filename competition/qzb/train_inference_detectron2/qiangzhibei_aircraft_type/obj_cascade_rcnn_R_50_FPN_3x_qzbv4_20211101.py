...
def example_train():
    ...
    config = os.path.join(curr_dir, '..','config','qiangzhibei_aircraft_type', 'train_config_cascade_rcnn_R_50_FPN_3x_qzbv4.sdt')
    backbone_weight_path = os.path.join(curr_dir, '..', 'backbone', 'R-50.pkl')

    log_path = os.path.join(curr_dir, '..', 'out', 'qzbv4', 'cascade_rcnn_R_50_FPN_3x','log')
    output_model_path = os.path.join(curr_dir, '..', 'out', 'qzbv4', 'cascade_rcnn_R_50_FPN_3x', 'model')
