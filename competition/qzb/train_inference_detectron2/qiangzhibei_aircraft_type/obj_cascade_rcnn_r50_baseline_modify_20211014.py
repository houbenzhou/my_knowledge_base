...
def example_train():
    train_data_path = r'E:\workspaces\iobjectspy_master\resources_ml\out\tainzhibei2\CASIA-Aircraft\get_01_05_08_casia_and_tzbv1400_and_get_02_03_05from_tzb'
    ...
    log_path = os.path.join(curr_dir, '..', 'out', 'qzb_rectangle_v2', 'r50_modify','log')
    output_model_path = os.path.join(curr_dir, '..', 'out', 'qzb_rectangle_v2', 'r50_modify', 'model')
    output_model_name = "save_model"
    lr= 0.005
    pretrained_model_path=None
    PictureTrainer(train_data_path=train_data_path, config=config, epoch=10, batch_size=4, lr=lr,
            output_model_path=output_model_path,
            output_model_name=output_model_name, backbone_name='renet50',
            backbone_weight_path=backbone_weight_path,pretrained_model_path=pretrained_model_path, log_path=log_path, reload_model=False,num_gpus=1).object_detect_train()
