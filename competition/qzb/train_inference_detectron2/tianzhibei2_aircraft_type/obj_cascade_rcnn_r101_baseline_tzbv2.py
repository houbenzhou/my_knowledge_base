...
def example_train():
    ...
    config = os.path.join(curr_dir, '..','config','tianzhibei2_aircraft_type', 'train_config_cascade_rcnn_R_101_FPN_3x_tzbv2.sdt')
    backbone_weight_path = os.path.join(curr_dir, '..', 'backbone', 'R-101.pkl')

    log_path = os.path.join(curr_dir, '..', 'out', 'tzbv2', 'baseline_r101','log')
    output_model_path = os.path.join(curr_dir, '..', 'out', 'tzbv2', 'baseline_r101', 'model')
