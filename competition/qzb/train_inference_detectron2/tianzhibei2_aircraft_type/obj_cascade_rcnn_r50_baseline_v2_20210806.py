...
def example_train():
    train_data_path = '/home/data1/competition/data/all_aircraft/tzb2_airplane_voc_v0_20210803/spllite_val_voc'
    config = os.path.join(curr_dir, '..','config','tianzhibei2_aircraft_type', 'train_config_cascade_rcnn_R_50_FPN_3x.sdt')
    backbone_weight_path = os.path.join(curr_dir, '..', 'backbone', 'R-50.pkl')

    log_path = os.path.join(curr_dir, '..', 'out', 'tzb2_airplane_voc_v0_20210803', 'baseline1','log')
    output_model_path = os.path.join(curr_dir, '..', 'out', 'tzb2_airplane_voc_v0_20210803', 'baseline1', 'model')
