...
def get_parser():
    ...
    parser.add_argument(
        "--voc_img",
        default=r"E:\workspaces\iobjectspy_master\resources_ml\out\tainzhibei2\spllite_val_voc\Images",
        help="voc image path",
    )
    parser.add_argument(
        "--voc_xml",
        default=r"E:\workspaces\iobjectspy_master\resources_ml\out\tainzhibei2\spllite_val_voc\Annotations",
        help="voc label path",
    )
    parser.add_argument(
        "--out_path",
        default=r'E:\workspaces\iobjectspy_master\resources_ml\out\tainzhibei2\spllite_val_voc_visual',
        help="A directory to save the output images . ",
    )
    # parser.add_argument(
    #     "--voc_img",
    #     default=r"E:\workspaces\iobjectspy_master\resources_ml\out\tainzhibei2\val_voc\Images",
    #     help="voc image path",
    # )
    # parser.add_argument(
    #     "--voc_xml",
    #     default=r"E:\workspaces\iobjectspy_master\resources_ml\out\tainzhibei2\val_voc\Annotations",
    #     help="voc label path",
    # )
    # parser.add_argument(
    #     "--out_path",
    #     default=r'E:\workspaces\iobjectspy_master\resources_ml\out\tainzhibei2\val_voc_visual',
    #     help="A directory to save the output images . ",
    # )

    # parser.add_argument(
    #     "--voc_img",
    #     default=r"E:\workspaces\iobjectspy_master\resources_ml\out\tainzhibei2\test\voc_splite\Images",
    #     help="voc image path",
    # )
    # parser.add_argument(
    #     "--voc_xml",
    #     default=r"E:\workspaces\iobjectspy_master\resources_ml\out\tainzhibei2\test\voc_splite\Annotations",
    #     help="voc label path",
    # )
    # parser.add_argument(
    #     "--out_path",
    #     default=r'E:\workspaces\iobjectspy_master\resources_ml\out\tainzhibei2\test\voc_splite_visual',
    #     help="A directory to save the output images . ",
    # )
