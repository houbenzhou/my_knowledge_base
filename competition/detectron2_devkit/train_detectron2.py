...
def train_iobjectspy_voc(train_data_path, train_config_path, weight_path, out_dir, register_train_name):
    cfg = get_cfg()
...
def get_parser():
    ...
    parser.add_argument(
        "--out_dir",
        default='/home/data/hou/workspaces/my_knowledge_base/competition/detectron2_devkit/out/temp',
...
if __name__ == '__main__':
    ...
    train_iobjectspy_voc(train_data_path, train_config_path, weight_path, out_dir, register_train_name)
