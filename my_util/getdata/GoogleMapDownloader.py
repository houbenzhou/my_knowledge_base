    ...
    def generateImage(self, **kwargs):
        ...
        for x in range(0, tile_width):
            for y in range(0, tile_height) :
                url = 'https://mt0.google.com/vt/lyrs=s&?&key=AIzaSyBaJu27jW1H7uSc51uUbKUiLdkRw4dsud0&x=' + str(start_x + x) + '&y=' + str(start_y + y) + '&z=' + str( self._zoom)
...
def main():
    ...
    #plane
    gmd = GoogleMapDownloader(40.074337, 116.606228, 18)
    #swimming-pool
    # gmd = GoogleMapDownloader(34.063982, -118.406086, 21)
    # car
    # gmd = GoogleMapDownloader(34.063982, -118.406086, 21)
    # gmd = GoogleMapDownloader(37.852722, -122.261208, 21)
